...
class AutoGoogleSheetsConnector:
          def __init__(self, spreadsheet_id: str):
                        ...
                        self.last_sync = None
                        logger.info(f"[OK] Google Sheets Connector ready: {spreadsheet_id}")
      ...
      class AutoAssignmentEngine:
        ...
        logger.info(f"Step 1: Fetched {len(leads)} leads from Google Sheets")
        ...
        logger.info(f"Total Pipeline Value: ${self.total_value_assigned:,}")
        ...
        logger.info("All leads automatically assigned based on:")
